...
import com.george.more.unique.weapons.item.swords.GravitySwordItem;
...
public class GravitySwordProvider {

    public static final String NAME = "gravity_sword";
    ...
    public static Item getItem(){
        ...
        return new GravitySwordItem(settings);
    };
